					...
					if (ListUtilisateur.size() > 0) {
						...
						switch (method3) {
							case "1":
								...
								utilisateur.FiltrageListManager(ListUtilisateur,"CP");
								break;
							case "2":
								//TEST
								System.out.println(" \n \t ---------------- \n \t la liste des Managers  (MN) \n \t ----------------");
								utilisateur.FiltrageListManager(ListUtilisateur,"MN");
								break;
							case "3":
								//test
								System.out.println(" \n \t ---------------- \n \t la liste des Directeur de projet (DP) \n \t ----------------");
								utilisateur.FiltrageListManager(ListUtilisateur,"DP");
								break;
							case "4":
								//TEST
								System.out.println(" \n \t ---------------- \n \t la liste des Directeur des ressources humaines (DRH) \n \t ----------------");
								utilisateur.FiltrageListManager(ListUtilisateur,"DRH");
								break;
							case "5":
								//test
								System.out.println(" \n \t ---------------- \n \t la liste des Directeur général (DG) \n \t ----------------");
								utilisateur.FiltrageListManager(ListUtilisateur,"DG");
								break;
							default:
						}
